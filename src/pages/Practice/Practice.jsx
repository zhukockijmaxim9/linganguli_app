...
const dailyTasks = [
  {
    ...
    status: 'Решено',
    xp: '+10 XP',
    description: 'Создайте простой калькулятор, который выполняет основные арифметические операции (сложение, вычитание, умножение, деление).',
    hints: ['💡 Используйте input() для ввода чисел', '💡 Примените условные операторы для выбора операции'],
  ...
  },
  {
    ...
    status: 'Решено',
    xp: '+10 XP',
    description: 'Напишите программу, которая проверяет, является ли введенное число четным или нечетным.',
  ...
  },
  {
    ...
    status: 'Решено',
    xp: '+20 XP',
    description: 'Создайте функцию, которая ищет элемент в списке и возвращает его индекс. Если элемент не найден, верните -1.',
    hints: ['💡 Используйте цикл for с enumerate()', '💡 Обработайте случай, когда элемент не найден'],
  ...
  },
  {
    ...
    status: 'В процессе',
    xp: '+10 XP',
    description: 'Напишите программу, которая вычисляет сумму всех чисел от 1 до n, где n вводится пользователем.',
...
const challenges = [
  {
    ...
    description: 'Реализуйте алгоритм поиска кратчайшего пути в графе с использованием алгоритма Дейкстры.',
    reward: '500 XP',
    time: '2 часа',
    difficulty: 'Сложно',
    featured: true,
...
const projects = [
  ...
  },
  {
    ...
    description: 'Создайте инструмент для анализа и визуализации данных с помощью pandas и matplotlib.',
    difficulty: 'Сложно',
    duration: '2-3 недели',
      ...
      <section className="section">
        <div className="container">
          ...
          <div className={`card ${styles.filterBar}`}>
            <nav className={styles.tabs} aria-label="Режимы практики">
        ...
        <div className="container">
          ...
          <div className={styles.challengeGrid}>
            {challenges.map((challenge) => (
              <article key={challenge.title} className={`card ${styles.challengeCard} ${challenge.featured ? styles.featured : ''}`}>
                {challenge.featured && <span className="badge">Текущий вызов</span>}
        ...
        <div className="container">
          ...
          <div className={styles.cardGrid}>
            {projects.map((project) => (
              <article key={project.title} className={`card ${styles.projectCard}`}>
        ...
        <div className="container">
          ...
          <div className={styles.cardGrid}>
            {algorithmCategories.map((category) => (
              <article key={category.title} className={`card ${styles.categoryCard}`}>
