  ...
  },
  {
    ...
    achievements: [
      ...
      },
      {
        icon: 'fas fa-brain',
        title: 'Алгоритмист',
        text: 'Решите 50 алгоритмических задач',
        reward: '+400 XP',
        progress: 20,
        earned: false,
      },
    ...
    achievements: [
      {
        icon: 'fas fa-fire',
        title: 'Начало пути',
        text: 'Поддерживайте streak 3 дня',
        reward: '+50 XP',
        date: '17 января 2024',
        earned: true,
      },
      {
        icon: 'fas fa-fire',
        title: 'Streak Master',
        text: 'Поддерживайте streak 7 дней',
        reward: '+100 XP',
        date: '22 января 2024',
        earned: true,
      },
      {
        icon: 'fas fa-fire',
        title: 'Непрерывность',
        text: 'Поддерживайте streak 30 дней',
        reward: '+500 XP',
        progress: 23,
        earned: false,
      },
      {
        icon: 'fas fa-fire',
        title: 'Легенда',
        text: 'Поддерживайте streak 100 дней',
        reward: '+1000 XP',
        progress: 7,
        earned: false,
      },
    ...
    achievements: [
      {
        icon: 'fas fa-heart',
        title: 'Первый день',
        text: 'Начните свое путешествие в мир Python',
        reward: '+25 XP',
        date: '15 января 2024',
        earned: true,
      },
      ...
      },
      {
        icon: 'fas fa-crown',
        title: 'Король Python',
        text: 'Достигните максимального уровня',
        reward: '+2000 XP',
        progress: 12,
        earned: false,
      },
        ...
        <div className={styles.container}>
          <div className={styles.highlightGrid}>
            {highlightStats.map((stat) => (
              <article key={stat.label} className={styles.highlightCard}>
